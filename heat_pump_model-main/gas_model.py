...
class gas_heater:
    ...
    def calculate_costs(self):
        ...
        # Calculating emissions costs NR - rebuilt this including changing the units in the yml file
        self.year_one_emissions = ((self.mysum(self.process_heat_requirement.to('MMBtu/hr')*Q_('1 hr/yr'))/self.thermal_efficiency)) * self.emissions_factor
